...
const faqData = [
  ...
  {
    id: "item-2",
    question: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis?",
  ...
  {
    id: "item-3",
    question: "Lorem ipsum dolor sit amet, consectetur adipiscing elit? Nunc vulputate libero et velit interdum, ac aliquet odio mattis Class aptent taciti sociosgu?",
    answer: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos."
  },
  {
    id: "item-4",
        ...
        <Accordion type="single" collapsible className="w-full">
          {faqData.map((faq) => (
            ...
            >
              <AccordionTrigger 
                hideChevron 
                className="px-6 py-5 text-left hover:no-underline transition-colors duration-200 [&[data-state=open]>.accordion-icon]:rotate-45"
              >
                <div className="flex items-center justify-between w-full">
                  <span className="text-base font-medium text-foreground pr-4 leading-relaxed">
                    {faq.question}
                  </span>
                  <div className="accordion-icon flex-shrink-0 w-6 h-6 rounded-full bg-background flex items-center justify-center transition-transform duration-200">
                    <svg 
                      width="12" 
                      height="12" 
                      viewBox="0 0 12 12" 
